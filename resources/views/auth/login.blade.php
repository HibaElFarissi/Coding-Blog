    ...
    <div class="flex">
        <div class="w-full">
            <section class="flex flex-col break-words bg-black sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <header class="font-semibold bg-black  text-green-500 text-l text-center py-5 px-6 sm:py-6 sm:px-8 sm:rounded-t-md">
                    {{ __('Login') }}
                </header>
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex items-center">
                        <label class="inline-flex items-center text-sm text-green-700" for="remember">
